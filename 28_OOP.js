...
class Persons {
    constructor() {
        this.name = "vaibhav";
        this.age = 21;
        this.hobbies = ["cricket", "gymnastic"];
    }
}
...
const persons2 = new Persons1("vaibhav", 21, ["coding", "cricket"]);
const persons3 = new Persons1("mitul", 24, ["communication", "share-market"]);
const persons4 = new Persons1("dharmik", 23, ["adjustment", "gym"]);
