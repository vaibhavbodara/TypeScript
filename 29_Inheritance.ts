...
const persons8:Persons2=new Persons2("vaibhav",21,["coding","cricket"]);
const persons7:Persons2=new Persons2("mitul",24,["communication","share-market"])
const persons6:Persons2=new Persons2("dharmik",23,["adjustment","gym"])
...
const students1:Students=new Students("vaibhav",21,["cricket","gymnastic"])
...
const students2:Students1=new Students1("vaibhav",21,["running","coding"],10)
